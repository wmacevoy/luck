...
\begin{figure}
  \caption{Histograms of luck values in same distributsions as table~\ref{tab:normal}.  Upshot: $y$ values in the $x$ distribution are viewed as extremely luckey and visa-versa, while they are have uniform luck in their own respective distributions.}
  \centering
