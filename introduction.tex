...
\begin{definition}{Luck.}  The luck of an outcome is the probability getting any more likely outome, plus half the probability of getting any equally likely outcome:
\begin{equation}
