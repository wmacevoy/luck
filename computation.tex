...
\begin{figure}
  \caption{Histogram of z error values for 10,000 numerical approximations of luck.  The maximum value of {\tt sd} was {\tt max(sd)=0.0048314}.}
  \centering
    \includegraphics[width=0.75\textwidth]{img/compz.png}
\end{figure}
